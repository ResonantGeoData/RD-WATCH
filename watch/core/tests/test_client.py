...
def test_post_stac_file(py_client: WATCHClient):
    file_url = 'https://landsatlook.usgs.gov/stac-server/collections/landsat-c2l1/items/LC09_L1GT_052212_20220308_20220308_02_T2'  # noqa
    res: Dict = py_client.watch.post_stac_file(
        url=file_url,
        name='LC09_L1GT_052212_20220308_20220308_02_T2',
        collection=None,
    )
    ...
    res: Dict = py_client.watch.post_stac_file(url=file_url, collection=None)
